...
const val SCHOOL_LIST_PAGE_INDEX = 1

class SchoolPagerAdapter(fragment: Fragment) : FragmentStateAdapter(fragment) {

    private val tabFragmentCreators: Map<Int, () -> Fragment> = mapOf(
        FAV_SCHOOL_LIST_PAGE_INDEX to { FavouriteListFragment() },
        SCHOOL_LIST_PAGE_INDEX to { SchoolListFragment() }
    )
